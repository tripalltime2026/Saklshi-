/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config dist/server/wrangler.json --env-interface CloudflareEnv` (hash: 345193746db4550a802ca4119142faff)
